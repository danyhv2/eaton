	...
	protected void init() {
		switch(listType) {
			...
			case CommonConstants.TAGS : {
					childPageAndTagsLinksList = new ArrayList<LinkListTypeBean>();
					if (null != this.tags && !StringUtils.equals(CommonConstants.PRIMARY_NAVIGATION, super.getView())) {
			...
			case CommonConstants.FIXED_LIST : {
					...
					if (null != this.fixedLinks && !StringUtils.equals(CommonConstants.PRIMARY_NAVIGATION, super.getView())) {
