...
public final class CommonConstants {
    ...
    public final static String ICON_IMAGE_ROOT = "/content/dam/eaton/images/icons";
    
    /**  Socail Links Drop down constants. */
    public final static String SOCIAL_ICON_ROOT_PATH = "/content/dam/eaton/images/sociallinks";
    ...
    public final static String TEASER_IMAGE_PATH = "teaser-image-path";
    
    /** The Constant FIXED_LIST. */
    public final static String FIXED_LIST = "fixed-list";
    
    /** The Constant LINK_PATH. */
    public final static String LINK_PATH = "linkPath";
    
    /** The Constant TRANS_HEADlINE. */
    public final static String TRANS_HEADlINE = "transHeadline";
    ...
    public final static String PUBLISH_DATE = "pub-date";
    
    /** The Constant CREATED_DT. */
    public final static String CREATED_DT = "created-date";
    
    /** The Constant LAST_MOD_DT. */
    public final static String LAST_MOD_DT = "last-modified-date";
    
    /** The Constant TEMPLATE. */
    public final static String TEMPLATE = "template";
    
    /** The Constant NEW_WINDOW_FIXED. */
    public final static String NEW_WINDOW_FIXED = "newWindowFixed";
    
    /** The Constant DESCRIPTION. */
    public final static String DESCRIPTION = "transDescription";
    
    /** The Constant TEASER_DESCRIPTION. */
    public final static String TEASER_DESCRIPTION = "teaser-description";
    
    /** The Constant DATE_FORMAT_PUBLISH. */
    public final static String DATE_FORMAT_PUBLISH = "MMMM d, yyyy";
    
    /** The Constant TEASER_TITLE. */
    public final static String TEASER_TITLE = "teaser-title";
    
    /** The Constant EYEBROW_TITLE. */
    public final static String EYEBROW_TITLE = "eyebrow-title";
    
    /** The Constant ALT_TXT. */
    public final static String ALT_TXT = "transAltTxt";
