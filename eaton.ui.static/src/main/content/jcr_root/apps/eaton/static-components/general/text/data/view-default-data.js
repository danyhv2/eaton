...
use(function () {
  ...
  if ((typeof(testdata) != "undefined") && (testdata == "footer")) {
	...
	data.text = '<p>See what people are saying about Eaton.</p>';
	    ...
	    data.text = '<p><span class="b-heading-h5">Placeline - Lead. Lorem ipsum solor etal, at sed laudem dolor anhorreant deseruisse. His vero cibo ne aed iuvared eruditi. Has putent meliore. aliquip adversarium ampedit mediocritatem has ne mundi nobis facilis.</span></p> \
	    <p>Duis aute irure dolor in reprehenderit in volumtate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia <a class="b-heading-h5" href="#">deserunt mollit</a> anim id est laborum. Sed ut perspepiciatis unde omnis iste natus error sit voluptament accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo excepteur, \
