...
use(function () {
  ...
  * Footer Top
  */
  footer.text = 'A Eaton is a power management company with 2016 sales of $19.7 billion. We provide energy-efficient solutions that help our customers effectively manage electrical, hydraulic and mechanical power more efficiently, safely and sustainably. Eaton is dedicated to improving the quality of life and the environment through the use of power management technologies and services. Eaton has approximately 95,000 employees and sells products to customers in more than 175 countries.';


  footer.linkListCompany = {
    eyebrow: 'Our Company',
    links: [
      {
        title: 'About Eaton',
  ...
  */
  ...
  footer.bottom.copyright = '© 2017 Eaton. All Rights Reserved.'
