...
use(function () {
  ...
  if ((typeof(testdata) != "undefined") && (testdata == "homepage-categoryhighlight")) {
    ...
    data.imgSrcMobile = "/content/dam/eaton/images/story_board.png";
    data.imgSrcTablet = "/content/dam/eaton/images/story_board.png";
    data.imgSrcDesktop = "/content/dam/eaton/images/story_board.png";
    ...
    data.imgSrc = "/content/dam/eaton/images/story_board.png?org";
    data.imgSrcMobile = "/content/dam/eaton/images/story_board.png?mobile";
    data.imgSrcTablet = "/content/dam/eaton/images/story_board.png?tablet";
    data.imgSrcDesktop = "/content/dam/eaton/images/story_board.png?desktop";
  }
